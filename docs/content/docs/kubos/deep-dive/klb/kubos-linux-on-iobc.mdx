---
title: "Building Kubos Linux for the ISIS-OBC"
---
...
- [../../obc-docs/iobc/installing-linux-iobc](../../obc-docs/iobc/installing-linux-iobc) - Steps to install Kubos Linux on an iOBC
...
- [../../obc-docs/iobc/working-with-the-iobc](../../obc-docs/iobc/working-with-the-iobc) - Guide for interacting with iOBC-specific features
...
[Product Page](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/Atmel%20SAM-BA%20In-system%20Programmer)
...
For information on how to create and run applications on your new Kubos Linux system, see the [../../obc-docs/iobc/working-with-the-iobc](../../obc-docs/iobc/working-with-the-iobc) guide.
