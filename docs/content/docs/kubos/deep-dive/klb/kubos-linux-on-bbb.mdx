---
title: "Building Kubos Linux for the Beaglebone Black"
---
...
The [../../ecosystem/linux-docs/kubos-linux-overview](../../ecosystem/linux-docs/kubos-linux-overview) doc covers the major components of Kubos Linux.
...
- [../../obc-docs/bbb/installing-linux-bbb](../../obc-docs/bbb/installing-linux-bbb) - Steps to install Kubos Linux
...
- [../../obc-docs/bbb/working-with-the-bbb](../../obc-docs/bbb/working-with-the-bbb) - Guide for interacting with BBB-specific features
...
The main U-Boot image iterates through the <span className="title-ref">boot_targets</span> variable to attempt to boot from an available MMC device. The partuuid of the first successful device is passed off to Linux to be used to mount the root filesystem.
...
> [!WARNING]
> The OS files cannot be built using a [synced folder](https://www.vagrantup.com/docs/synced-folders/) in a Vagrant box (or regular VM). VirtualBox does not support hard links in shared folders, which are crucial in order to complete the build.

[SSH into a Kubos SDK box](../../sdk-docs/sdk-installing)
...
The <span className="title-ref">kubos-linux.tar.gz</span> and <span className="title-ref">aux-sd.tar.gz</span> files are the two final files which will be used to install Kubos Linux onto your target board.
...
For information on how to create and run applications on your new Kubos Linux system, see the [../../obc-docs/bbb/working-with-the-bbb](../../obc-docs/bbb/working-with-the-bbb) guide.

## Configuring Kubos Linux

For information on how to customize your build of Kubos Linux, see the `configuring-kubos` guide.
