...
The read function should be used to read data from an I2C device. It takes two arguments: the I2C address of the slave device and the number of bytes to read.
...
The write function should be used to write to an I2C device. The function takes two arguments:
