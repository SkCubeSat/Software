...
Now we'll be setting up our instance of the <a href="https://kubos-preservation-group.github.io/kubos/rust-docs/kubos_comms/struct.CommsControlBlock.html" target="_blank">CommsControlBlock</a>, which is the main control structure used by the communications service framework in order to store all of the settings and communication components.

The <a href="https://kubos-preservation-group.github.io/kubos/rust-docs/kubos_comms/struct.CommsControlBlock.html" target="_blank">CommsControlBlock</a> contains five elements:
...
Finally, we can start our communication threads. We'll use the <a href="https://kubos-preservation-group.github.io/kubos/rust-docs/kubos_comms/struct.CommsService.html#method.start" target="_blank">CommsService::start</a> function, passing it our control block as well as a <a href="https://kubos-preservation-group.github.io/kubos/rust-docs/kubos_comms/struct.CommsTelemetry.html" target="_blank">CommsTelemetry</a> instance to use for recording communication metrics.
...
The telemetry structure, <a href="https://kubos-preservation-group.github.io/kubos/rust-docs/kubos_comms/struct.CommsTelemetry.html" target="_blank">CommsTelemetry</a>, has the following fields:
