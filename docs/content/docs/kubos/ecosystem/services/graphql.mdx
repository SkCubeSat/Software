...
GraphQL is a query language used to simplify commanding and telemetry gathering on the satellite. More information about GraphQL in general can be found here: [http://graphql.org/](http://graphql.org/)

## What uses GraphQL?

All [hardware services](hardware-services) are GraphQL endpoints where:
