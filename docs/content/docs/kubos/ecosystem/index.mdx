...
- Hardware services expose the functionality of a connected hardware device (ADCS, GPS, radio, etc) to the rest of the bus. They should be re-usable between missions. KubOS comes with support for a certain selection of [pre-built hardware services](/docs/kubos#supported-hardware).
