...
#[test]
fn default_config() {
    let config = radsat_system::Config::default();
...
#[test]
fn new_from_str() {
    let config = radsat_system::Config::new_from_str(
        "category-1",
        r#"
    [category-1]
    a = 1
...
fn new_from_file() {
    ...
    let config = radsat_system::Config::new_from_path(
        "category-1",
...
#[test]
fn missing_port() {
    let result = radsat_system::Config::new_from_str(
        "category-1",
        r#"
    [category-1.addr]
    ip = "10.0.1.1"
